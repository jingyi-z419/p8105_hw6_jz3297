...
```
    ...
    ##    <chr>        <chr>          <dbl>     <dbl>
    ##  1 0001         (Intercept)     7.19     0.911
    ##  2 0001         tmin            1.04     0.911
    ##  3 0002         (Intercept)     7.69     0.899
    ##  4 0002         tmin            1.03     0.899
    ##  5 0003         (Intercept)     7.07     0.909
    ##  6 0003         tmin            1.04     0.909
    ##  7 0004         (Intercept)     7.35     0.903
    ##  8 0004         tmin            1.02     0.903
    ##  9 0005         (Intercept)     6.88     0.912
    ## 10 0005         tmin            1.03     0.912
