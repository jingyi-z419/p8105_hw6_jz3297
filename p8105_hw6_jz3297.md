...
```
    ...
    ##    <chr>        <chr>          <dbl>     <dbl>
    ##  1 0001         (Intercept)     7.44     0.897
    ##  2 0001         tmin            1.03     0.897
    ##  3 0002         (Intercept)     7.10     0.899
    ##  4 0002         tmin            1.04     0.899
    ##  5 0003         (Intercept)     7.26     0.916
    ##  6 0003         tmin            1.03     0.916
    ##  7 0004         (Intercept)     7.59     0.905
    ##  8 0004         tmin            1.02     0.905
    ##  9 0005         (Intercept)     7.33     0.917
    ## 10 0005         tmin            1.05     0.917
